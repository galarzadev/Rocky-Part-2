    ...
    public class ProductController : Controller
    {
        ...
        public IActionResult Upsert(int? id)
        {
            ...
            ProductVM productVM = new ProductVM()
            {
                ...
                ApplicationTypeSelectList = _prodRepo.GetAllDropdownList(WC.ApplicationName)
            };
        ...
        public IActionResult Upsert(ProductVM productVM)
        {
            ...
            productVM.ApplicationTypeSelectList = _prodRepo.GetAllDropdownList(WC.ApplicationName);
